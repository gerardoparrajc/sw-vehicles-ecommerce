...
@Component({
    ...
    <div class="home-container">
      ...
      <section class="hero-section">
        <div class="hero-content">
          <h1 class="hero-title">
            Vehículos de <span class="highlight">Star Wars</span>
          </h1>
          <p class="hero-subtitle">
            Explora la galaxia más lejana con nuestra colección exclusiva de vehículos y naves espaciales
          </p>
          <div class="hero-actions">
            <a routerLink="/vehicles" class="btn btn-primary btn-large">
              Explorar Catálogo
            </a>
            <a routerLink="/cart" class="btn btn-secondary btn-large">
              Ver Carrito
            </a>
          </div>
        </div>
      ...
      <section class="features-section">
        <div class="section-header">
          <h2 class="section-title">¿Por qué elegir nuestros vehículos?</h2>
        ...
        <div class="features-grid">
          ...
          <div class="feature-card">
            ...
            <p class="feature-description">
              Equipados con la más avanzada tecnología de hiperespacio
            </p>
          </div>
        </div>
      </section>
      ...
      <section class="featured-section">
        <div class="section-header">
          ...
          <p class="section-subtitle">
            Los más populares de la galaxia
          </p>
        </div>
        ...
        <div *ngIf="error()" class="error-message">
          <h3>Error al cargar vehículos destacados</h3>
          <p>{{ error() }}</p>
        </div>
        ...
        >
          <app-vehicle-card
            *ngFor="let vehicle of featuredVehicles(); trackBy: trackByVehicle"
            [vehicle]="vehicle"
            (addToCartClick)="onAddToCart($event)"
          />
        </div>

        <div class="view-all-section" *ngIf="!isLoading() && !error()">
          <a routerLink="/vehicles" class="btn btn-outline">
      ...
      <section class="stats-section">
        <div class="stats-grid">
          ...
          <div class="stat-item">
            ...
            <div class="stat-label">Sistemas Solares</div>
          </div>
          <div class="stat-item">
            <div class="stat-number">24/7</div>
            <div class="stat-label">Soporte Galáctico</div>
          </div>
        </div>
      </section>
    </div>
  ...
  styles: [`
    ...
    .hero-section {
      ...
      background: linear-gradient(135deg, #0c0c0c 0%, #1a1a1a 50%, #2c3e50 100%);
      overflow: hidden;
    }
